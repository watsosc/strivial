...
def load_rides():
    ...
    if user_has_valid_token:
        ...
        return render_template('pages/main.load.html', logged_in=app.strava.logged_in, athlete_name=app.strava.get_athlete_name())
    else:
        return render_template('pages/main.auth.html', logged_in=app.strava.logged_in)