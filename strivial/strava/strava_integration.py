...
class StravaIntegration:
    ...
    '''
    gets a valid access token for a user with the given username if one exists
    '''
    ...
    '''
    logs a user out, we delete their User object but no need to delete the Athlete object since
